	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<input type="text" name="proveedor" id="proveedor" placeholder="Nombre del proveedor" onkeyup="this.value=Letras(this.value)">
				<label for="contacto">Contacto: </label>
				<input type="text" name="contacto" id="contacto"placeholder="Nombre completo del contacto" onkeyup="this.value=Letras(this.value)">
