...
if (isset($_GET['order_id']) && is_numeric($_GET['order_id'])) {
	...
	$pdf->Cell(150, 10, utf8_decode(strtoupper("Citaviso")), 0, 0, 'L');
	...
	$pdf->Cell(150, 9, utf8_decode("Quito-Ecuador"), 0, 0, 'L');

	$pdf->Ln(5);

	$pdf->Cell(150, 9, utf8_decode("Teléfono: 0981515127"), 0, 0, 'L');

	$pdf->Ln(5);

	$pdf->Cell(150, 9, utf8_decode("Email: citaviso@gmail.com"), 0, 0, 'L');

	$pdf->Ln(10);

	$pdf->SetFont('Arial', '', 10);
	$pdf->Cell(30, 7, utf8_decode(date("d/m/Y h:i A")), 0, 0);
	$pdf->SetTextColor(97, 97, 97);
	$pdf->Cell(116, 7, utf8_decode(date("h:s A")), 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 10);
	$pdf->SetTextColor(39, 39, 51);
	$pdf->Cell(35, 7, utf8_decode(strtoupper($order['id'])), 0, 0, 'C');
