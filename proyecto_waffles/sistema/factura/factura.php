...
<div id="page_pdf">
		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p>Cédula: <?php echo $configuracion['nit']; ?></p>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>No. Orden: <strong><?php echo $factura['nofactura']; ?></strong></p>
					<p>Fecha: <?php echo $factura['fecha']; ?></p>
					<p>Hora: <?php echo $factura['hora']; ?></p>
					<p>Emisor: <?php echo $factura['vendedor']; ?></p>
				</div>
			</td>
		</tr>
	</table>
	<table id="factura_cliente">
		<tr>
			<td class="info_cliente">
				<div class="round">
					<span class="h3">Destinatario</span>
					<table class="datos_cliente">
						<tr>
							<td><label>Cédula:</label><p><?php echo $factura['nit']; ?></p></td>
	...
	<div>
		<p class="nota">Si existe problemas con esta orden, <br>pongase en contacto con administración</p>
		<h4 class="label_gracias">¡ORDEN EN PROCESO!</h4>
	</div>
